...
### 4.1. Визначення перехідного періоду (T = 1000 днів)

Було проведено 5 пробних запусків на 5000 днів для візуального аналізу виходу системи на сталий режим. Графік (рис 4.1) показує високу стохастичність, але стабілізацію середньої поведінки (товста лінія) **після ~1000 днів**.
...
| :--- |:-----------------|:-------------------------------------------------------------------|
| **Середнє завантаження 1 крана** | **~40.0%**       | ідеально збігається з теоретичним 0.4. Система недовантажена).     |
| **Середня к-сть зайнятих стоянок**| **~0.554**       | З 2-х доступних стоянок в середньому зайнято 0.554.                |
| **Середня довжина черги** | **~0.062** судна | Система дуже стабільна, черга практично відсутня.                  |
| **Середній час у гавані** | **~0.770** днів  | Середній час корабля в системі (черга + розвантаження).            |
| **Мін. час у гавані** | **0.25** днів        | Теоретичний мінімум (0.5 дня / 2 крани).                           |
| **Макс. час у гавані** | **~6.80** днів     | Демонструє високу стабільність. Ризик значних заторів мінімальний. |
